...
import dataPlacement.FcmPSOPartition;
...
public class FCMPSOSimulator extends CloudSimulator {
    ...
    public FCMPSOSimulator(ArrayList<DataCenter> aDataCenters, RuntimeAlgorithm aRuntime, BuildTimeAlgorithm aBuildtime) {
        super(aDataCenters);
    ...
    public String simulateWorkflow(Workflow aWorkflow) throws Exception {
        ...
        FcmPSOPartition ff = new FcmPSOPartition(lUtilisedCenters, this.fClusteredMatrix);
        lUtilisedCenters = ff.getFuzzyDC();
        System.out.println("FCM_PSO ------------------------>" + lUtilisedCenters.toString());
