...
public class FlexiSimulator extends CloudSimulator {
    ...
    public FlexiSimulator(ArrayList<DataCenter> aDataCenters, RuntimeAlgorithm aRuntime, BuildTimeAlgorithm aBuildtime) {
        super(aDataCenters);
    ...
    public String simulateWorkflow(Workflow aWorkflow) throws DistributionException {
        String result = "";
