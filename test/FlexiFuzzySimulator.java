...
import dataPlacement.FcmPartition;
...
public class FlexiFuzzySimulator extends CloudSimulator {
    private RuntimeAlgorithm fRuntime;
    private BuildTimeAlgorithm fBuildtime;
    private FuzzyRuntime fuzRuntime;
    ...
    public FlexiFuzzySimulator(ArrayList<DataCenter> aDataCenters, RuntimeAlgorithm aRuntime, BuildTimeAlgorithm aBuildtime) {
        super(aDataCenters);
    ...
    public String simulateWorkflow(Workflow aWorkflow) throws Exception {
        ...
        FcmPartition ff = new FcmPartition(lUtilisedCenters, this.fClusteredMatrix);
