...
public class Fuzzy_parametre {
    private static int essaie_number = 5;
    private static int num_cluster = 2;
    private static double fuzziness = 1.25;
    private static double valmax_x = 500.0;
    private static double valmin_x = 0.0;
    private static double valmax_y = 1000.0;
    private static double valmin_y = 500.0;
